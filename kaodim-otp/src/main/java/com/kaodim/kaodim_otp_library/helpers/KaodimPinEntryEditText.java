package com.kaodim.kaodim_otp_library.helpers;
...
public class KaodimPinEntryEditText extends EditText {
    ...
    protected com.alimuzaffar.lib.pin.PinEntryEditText.OnPinEnteredListener mOnPinEnteredListener = null;
    ...
    public KaodimPinEntryEditText(Context context) {
        super(context);
    }

    public KaodimPinEntryEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public KaodimPinEntryEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public KaodimPinEntryEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        mColors[0] = R.color.black; //selected
//        mColors[1] = Color.GREEN;
//        mColors[2] = R.color.sessions_grey_light; //untouched

        mColors[0] = Color.DKGRAY; //selected
        mColors[1] = Color.GREEN;
        mColors[2] = Color.LTGRAY; //selected
    ...
    private void animatePopIn() {
        ...
        va.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                KaodimPinEntryEditText.this.invalidate();
            }
        });
    ...
    public void setOnPinEnteredListener(com.alimuzaffar.lib.pin.PinEntryEditText.OnPinEnteredListener l) {
